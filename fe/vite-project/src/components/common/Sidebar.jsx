...
const Sidebar = () => {
        ...
        const { limits, isLoading: limitsLoading } = useDailyLimits();
                        ...
                        <div className='vintage-sidebar sticky top-0 left-0 h-screen flex flex-col w-20 md:w-full'>
                                ...
                                <ul className='flex flex-col gap-2 mt-4 px-2'>
                                        ...
                                        {!balanceLoading && userBalance && (
                                                <li className='flex justify-center md:justify-start mb-2'>
                                                        <Link to='/transactions' className='balance-display w-full rounded block hover:opacity-90 transition-opacity'>
                                                                <div className='flex items-center gap-2'>
                                                                        <span className='text-lg'>🪙</span>
                                                                        <div className='flex flex-col'>
                                        ...
                                        {!limitsLoading && limits && (
                                                <li className='flex justify-center md:justify-start mb-4'>
                                                        <div className='vintage-card-inset w-full rounded p-2'>
                                                                <span className='text-xs text-bark font-bold block mb-1' style={{fontFamily: 'Arial, sans-serif'}}>
                                                                        Daily Limits
                                                                </span>
                                                                <div className='text-xs text-soil space-y-0.5'>
                                                                        <div>Posts: {limits.posts?.remaining}/{limits.posts?.limit}</div>
                                                                        <div>Comments: {limits.comments?.remaining}/{limits.comments?.limit}</div>
                                                                        <div>Likes: {limits.likes?.remaining}/{limits.likes?.limit}</div>
                                                                </div>
                                                        </div>
                                                </li>
                                        )}
                                        ...
                                        <li className='flex justify-center md:justify-start'>
                                                ...
                                                >
                                                        ...
                                                        <span className='text-base hidden md:block font-bold' style={{fontFamily: 'Arial, sans-serif'}}>Transactions</span>
                                                </Link>
                                        </li>
                                        <li className='flex justify-center md:justify-start'>
                                                <Link
                                                ...
                                                >
                                                        ...
                                                        <div className='flex justify-between flex-1 items-center'>
                                                                <div className='hidden md:block'>
                                                                        ...
                                                                        <p className='text-soil text-xs'>Rep: {authUser?.reputation || 50}</p>
                                                                </div>
                                                                <BiLogOut
